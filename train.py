    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                ...
                # IRM
                if opt.irm:
                    loss, loss_items, penalty = compute_loss(pred, targets.to(device), irm=True)  # loss scaled by batch_size
                    loss += penalty
                else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--irm', action='store_true', help='use IRM for generalization')
